...
trv = Treeview(window1, columns=(1, 2, 3, 4, 5, 6),
...
entSearch.delete(0, END)
btnSearch = Button(window2, text="Szukaj",
                   command=search, font=("bold", 12),
                   activebackground="yellow")
btnSearch.pack(side=tk.LEFT, padx=6)
btnClear = Button(window2, text="Wyczyść",
                  command=clear, font=("bold", 12),
                  activebackground="yellow")
...
ent7.grid(row=7, rowspan=2, column=1, padx=5, pady=3,
          ipady=80, ipadx=40, sticky=NSEW)

# sekcja szczegóły buttony
btnSMS = Button(window3, text="Wyślij", command=sendSMS,
                font=("bold", 12), activebackground="yellow")
btnSMS.grid(row=9, column=1, padx=5, pady=3, sticky=E)

btnClearSMS = Button(window3, text="Wyczyść treść", command=clearText,
                     font=("bold", 12), activebackground="yellow")
